...
# Test-LocalizedData 'fr-FR' 'G:\PS\PsIonic\Psionic' 'PsionicLocalizedData.psd1' 'Psionic.psm1' 'PsionicMsgs\.'
 ...
 process {          
  try {
   ...
   $result=$true
    Push-location $pwd
    Write-Verbose "Validate the culture $Culture" 
    ...
    $HelpMsg.Keys|
     Foreach {
      ...
      Write-Debug "Search the key $_"
       #bug PS : https://connect.microsoft.com/PowerShell/feedback/details/684218/select-strings-quiet-never-returns-false
