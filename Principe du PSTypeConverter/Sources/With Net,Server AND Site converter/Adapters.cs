...
namespace GetAdmin
{
    ...
    public class NetConverter : PSTypeConverter
    {
        ...
        {
            Logger.log.Info("NetConverter.CanConvertFrom [Object]");
        ...
        {
            Logger.log.Info("NetConverter.ConvertFrom [Object]");
            string src = sourceValue as string;
        ...
        {
            Logger.log.Info("NetConverter.CanConvertTo [Object]");
            return false;
        }
        ...
        {
            Logger.log.Info("NetConverter.ConvertTo [Exception]");
    ...
    public class ServerConverter : PSTypeConverter
    {
        ...
        {
          Logger.log.Info("ServerConverter.CanConvertFrom [PSObject]");
        ...
        {
            Logger.log.Info("ServerConverter.ConvertFrom [PSObject]");
       ...
       {
           Logger.log.Info("ServerConverter.ConvertFrom [Object][Exception]");
           throw new NotImplementedException();
       }
       ...
       {
          Logger.log.Info("ServerConverter.CanConvertTo [Object]");
          return false;
       }

       public override bool CanConvertTo(PSObject sourceValue, Type destinationType)
       {
           Logger.log.Info("ServerConverter.CanConvertTo [PSObject][Exception]");
           throw new NotImplementedException();
       }
       ...
       {
           Logger.log.Info("ServerConverter.ConvertTo [Object][Exception]");
       ...
       {
           Logger.log.Info("ServerConverter.ConvertTo [PSObject][Exception]");
           throw new NotImplementedException();
       }
    }
    ...
    public class Server
    {
        public string    Name    { get; set; }
         // [GetAdmin.Server]::new('test',@("eth0,192.168.1.1,255.255.255.0"))
         // ArrayList n'est pas typé, autorise une chaîne ...
        ...
        // no conversion, Network contains a string
        public Server(
            string name,
            ArrayList network
        )
